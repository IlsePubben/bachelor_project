import sys
from snakeGame import visual_game, util 
...
if __name__ == '__main__': 
    ...
    if param.algorithm == 'q-learning':
        ...
        model = neuralNetwork.NeuralNetwork(100,4)
        ...
        vmodel = neuralNetwork.NeuralNetwork(100,1)
        qmodel = neuralNetwork.NeuralNetwork(100,4)
        while algorithms.epoch < param.max_epochs:
        ...
        qmodel = neuralNetwork.NeuralNetwork(100,4)
        vmodel = neuralNetwork.NeuralNetwork(100,1)
        amodel = neuralNetwork.NeuralNetwork(100,4)
        while algorithms.epoch < param.max_epochs:
